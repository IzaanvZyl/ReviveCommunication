...
import { ReportDiscService } from 'src/app/Services/report-disc.service';
import { Router } from '@angular/router';
import { LoginService } from 'src/app/Services/login.service';

@Component({
  selector: 'app-report-disc',
  templateUrl: './report-disc.component.html',
  styleUrls: ['./report-disc.component.scss']
})
export class ReportDiscComponent implements OnInit {
  ReportDisc;
  ...
  constructor(private router:Router, 
    private service: ReportDiscService, 
    private toastrService:NbToastrService, 
    private dialogService:NbDialogService, 
    private formBuilder:FormBuilder, 
    private sidebarService: NbSidebarService, 
    private loginService: LoginService) {
    this.ReportDisc=this.formBuilder.group({
      DiscipleshipFeedbackID:'',
      Date:'',
      Description:'',
      DiscipleshipType:'',
      Attendance:'',
