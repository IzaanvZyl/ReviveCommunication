...
import { ReportZoneHCService } from 'src/app/Services/report-zone-hc.service';
import { Router } from '@angular/router';
import { GoalsServiceService } from 'src/app/Services/goals.service';
import { LoginService } from 'src/app/Services/login.service';

@Component({
  selector: 'app-report-zone-hc',
  templateUrl: './report-zone-hc.component.html',
  styleUrls: ['./report-zone-hc.component.scss']
})
export class ReportZoneHCComponent implements OnInit {
  ...
  constructor(private GoalsService: GoalsServiceService, 
    ...
    private service: ReportZoneHCService, 
    private toastrService:NbToastrService, 
    private dialogService:NbDialogService, 
    private formBuilder:FormBuilder, 
    private sidebarService: NbSidebarService,
    private loginService: LoginService) {
    this.ReportZoneHC=this.formBuilder.group({
      ZoneGrowthFeedbackID:'',
      Date:'',
      Description:'',
      Members:'',
      Leader:'',
  ...
  ngOnInit(): void {
    this.ZoneHomecellAttGoalID = this.GoalsService.getData();
