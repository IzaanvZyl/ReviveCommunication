...
import {ReportZoneChurchAttService} from 'src/app/Services/report-zone-church-att.service';
import { Router } from '@angular/router';
import { LoginService } from 'src/app/Services/login.service';

@Component({
  selector: 'app-report-zone-church-att',
  templateUrl: './report-zone-church-att.component.html',
  styleUrls: ['./report-zone-church-att.component.scss']
})
export class ReportZoneChurchAttComponent implements OnInit {
  ReportZoneChurchAtt;
  ...
  constructor(private router:Router, 
    ...
    private service: ReportZoneChurchAttService, 
    private toastrService:NbToastrService, 
    private dialogService:NbDialogService, 
    private formBuilder:FormBuilder,
    private loginService: LoginService) { 
    this.ReportZoneChurchAtt=this.formBuilder.group({
      ZoneChurchAttFeedbackID:'',
      Date:'',
      Description:'',
      Members:'',
      Leader:'',
  ...
  AddZoneChurchAttform(form)
  {
    console.log(form);
    this.service.AddZoneHCAtt(form);
  }
