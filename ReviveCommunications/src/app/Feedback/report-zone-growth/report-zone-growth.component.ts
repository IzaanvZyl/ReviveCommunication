...
import { ReportZoneGrowthService } from 'src/app/Services/report-zone-growth.service';
import { Router } from '@angular/router';
import { LoginService } from 'src/app/Services/login.service';

@Component({
  selector: 'app-report-zone-growth',
  templateUrl: './report-zone-growth.component.html',
  styleUrls: ['./report-zone-growth.component.scss']
})
export class ReportZoneGrowthComponent implements OnInit {
  ReportZoneGrowth;
  ...
  constructor(private router:Router, 
    ...
    private service: ReportZoneGrowthService, 
    private toastrService:NbToastrService, 
    private dialogService:NbDialogService, 
    private formBuilder:FormBuilder,
    private loginService: LoginService) { 
    this.ReportZoneGrowth=this.formBuilder.group({
  ...
  {
    console.log(form);
    this.service.AddZoneGrowth(form);
  }
