...
import { ReportOnHCAttService} from 'src/app/Services/report-on-hc-att.service';
...
@Component({
  selector: 'app-report-on-hc-att',
  templateUrl: './report-on-hc-att.component.html',
  styleUrls: ['./report-on-hc-att.component.scss']
})
export class ReportOnHCAttComponent implements OnInit {
  ...
  constructor(private GoalsService: GoalsServiceService, 
    ...
    private service: ReportOnHCAttService, 
    private toastrService:NbToastrService, 
    private dialogService:NbDialogService, 
    private formBuilder:FormBuilder, 
    private sidebarService: NbSidebarService,
    private loginService: LoginService) {
    this.ReportOnHCAtt=this.formBuilder.group({
      HomecellAttendanceFeedbackID:'',
      Date:'',
      Description:'',
      Members:'',
      Leaders:'',
  ...
  ngOnInit() {
    this.HomecellAttendanceGoalID = this.GoalsService.getData();
    console.log(this.HomecellAttendanceGoalID)
