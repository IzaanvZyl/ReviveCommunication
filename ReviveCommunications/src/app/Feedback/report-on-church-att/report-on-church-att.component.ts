...
import { ReportOnChurchAttService } from 'src/app/Services/report-on-church-att.service';
import { Router } from '@angular/router';
import { GoalsServiceService } from 'src/app/Services/goals.service';
import { LoginService } from 'src/app/Services/login.service';

@Component({
  selector: 'app-report-on-church-att',
  templateUrl: './report-on-church-att.component.html',
  styleUrls: ['./report-on-church-att.component.scss']
})
export class ReportOnChurchAttComponent implements OnInit {
  ...
  constructor(private GoalsService: GoalsServiceService, 
    ...
    private service: ReportOnChurchAttService, 
    private toastrService:NbToastrService, 
    private dialogService:NbDialogService, 
    private formBuilder:FormBuilder,
    private sidebarService: NbSidebarService,
    private loginService: LoginService) {
    this.ReportOnChurchAtt=this.formBuilder.group({
      ChurchAttFeedbackID:'',
      Date:'',
      Description:'',
      Member:'',
  ...
  ngOnInit(): void {
    this.ChurchAttGoalID = this.GoalsService.getData();
  ...
  AddChurchAttform(form)
  {
    console.log(form);
    this.service.AddChurchAtt(form);
  }
