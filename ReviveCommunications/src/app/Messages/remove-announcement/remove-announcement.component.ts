...
@Component({
  ...
  templateUrl: './remove-announcement.component.html',
  styleUrls: ['./remove-announcement.component.scss']
})
export class RemoveAnnouncementComponent implements OnInit {

  Announcement;
  PersonID = 18;
  constructor(
    private service : MessageService,
    private toastrService: NbToastrService,private sidebarService: NbSidebarService,
  ...
  if(!localStorage.getItem("accessToken")){
   ...
   this.service.retrieveAllAnnouncements(this.PersonID).subscribe(x =>{
    this.Announcement = x;
   })
  }
  ...
  onDelete(a) {
    ...
    {
      this.service.DeleteAnnouncement(a).subscribe(x =>{
