...
@Component({
  selector: 'app-add-homecell-notes',
  templateUrl: './add-homecell-notes.component.html',
  styleUrls: ['./add-homecell-notes.component.scss']
})
export class AddHomecellNotesComponent implements OnInit {
