...
@Component({
  selector: 'app-follow-up-member',
  templateUrl: './follow-up-member.component.html',
  styleUrls: ['./follow-up-member.component.scss']
})
export class FollowUpMemberComponent implements OnInit {
  MemberView : any;

  Person:any;
	  session:any;
  constructor( private service: FollowUpMemberService,
  ...
  ngOnInit()
  {
    this.MemberView = this.service.getMembers().subscribe(x => {
      console.log(x);
      this.MemberView = x
    });
