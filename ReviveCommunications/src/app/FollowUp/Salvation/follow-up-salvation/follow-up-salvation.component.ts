...
Salvations: any;
  ...
  Person:any;
	  session:any;
  constructor(private loginService: LoginService, private SalvationService: SalvationServiceService,  private toastrService: NbToastrService, private router: Router, private sidebarService: NbSidebarService) { }
  ...
  ngOnInit(): void {
    ...
    this.SalvationService.getSalvation().subscribe(data=> {this.Salvations = data;
      ...
      //does this send a persentage or a number because progress bar expectes number only
  ...
  //Create array of objects
    ...
    FollowedUp(SalID){
    this.SalvationService.FollowUpCompleted(SalID);
    this.SuccessMessage('top-right','success');
    this.router.navigate['FollowUpSalvation'];
    console.log(SalID);
    location.reload();
  }
  ...
  NoAnswer(SalID)
  {
    this.SalvationService.FollowUpNoAnswer(SalID);
