...
@Component({
  selector: 'app-salvation-view',
  templateUrl: './salvation-view.component.html',
  styleUrls: ['./salvation-view.component.scss']
})
export class SalvationViewComponent implements OnInit {
  Person:any;
  session:any;
