...
export class ResetPasswordComponent implements OnInit {
  ...
  constructor(private loginService: LoginService,private restpassService: ResetPasswordService, private sidebarService: NbSidebarService, private router: Router) { }
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    this.restpassService.getThisPerson().subscribe(x => {
      console.log(x);
      this.thisPerson = x;
    })
  }
  ...
  onSubmit(thisperson){
    this.restpassService.ResetPassword(this.thisPerson);
  }
 ...
 closeForm() {
  ...
  {
    console.log(person);
    this.restpassService.sendOTP(person);
  }
}
