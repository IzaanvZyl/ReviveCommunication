...
export class AddGroupComponent implements OnInit {
  ...
  if(!localStorage.getItem("accessToken")){
    ...
    this.groupService.getCity().subscribe
    (
      cdata => 
      {
        this.grouptypes = cdata;
        console.log(cdata)
      }
    );
    this.groupService.getProvince().subscribe
    (
      gdata => 
      {
        this.grouptypes = gdata;
    ...
    this.groupService.getCountry().subscribe
    (
      gdata => 
      {
        this.grouptypes = gdata;
  ...
  {
    //console.log(form)
    this.groupService.addGroup(form);
  }
